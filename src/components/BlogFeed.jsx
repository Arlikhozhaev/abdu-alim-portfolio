        ...
        <input
          ...
          className={
            isDesktop
              ...
              : "w-full rounded-xl border border-white/10 bg-white/8 py-3 pl-10 pr-4 text-sm text-white placeholder:text-white/35 outline-none focus:border-[#0A84FF]/50 transition-colors"
          }
        />
      </div>
        ...
        <p
          className={
            isDesktop
              ...
              : "text-sm text-white/40 text-center py-8"
          }
        >
          ...
          isDesktop ? (
            ...
            >
              <div className="overflow-hidden rounded-2xl bg-[#2c2c2e]">
                ...
                />
                <div className="p-3.5">
                  <p className="m-0 mb-1.5 text-[11px] text-white/40">{date}</p>
                  <p className="m-0 mb-2.5 text-[15px] font-semibold leading-snug text-white">
                    {title}
                  </p>
